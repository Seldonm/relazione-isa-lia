...
In primis occorre scaricare \href{http://spark.apache.org/downloads.html}{Apache Spark}. La versione utilizzata è stata la "\textbf{Pre-built for Hadoop 2.6 and later}".
...
\item {\textbf{Configurazione di Kafka}}
\end{itemize}
