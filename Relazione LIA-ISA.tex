...
Apache Spark è un sistema di cluster computing di tipo general-purpose, scalabile e veloce. Dispone di API di alto livello in Java, Scala, Python ed R, e un engine ottimizzato che supporta grafi di esecuzione generici. 
