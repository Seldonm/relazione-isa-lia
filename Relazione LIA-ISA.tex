...
Il pattern Facade, è un pattern strutturale che consente di fornire un'interfaccia semplice ed unificata, che consente di accedere ai diversi sottosistemi dotati di interfacce complesse e diverse tra loro.

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.50]{images/facade.jpg}
