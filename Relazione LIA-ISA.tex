...
Il sistema progettato ed implementato a livello di middleware per il collaborative filtering, utilizza le seguenti tecnologie: Apache Spark, Apache Kafka, Node.js, Angular.js. I linguaggi di programmazione usati sono Scala e Javascript.
