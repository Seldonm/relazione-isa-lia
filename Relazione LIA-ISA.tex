...
\end{itemize}
\end{itemize}
Separando il Model dalla View e dal Controller, consente l'associazione di più View allo stesso Model. Nel caso in cui l'utilizzatore modifica i dati contenuti nel model mediante il Controller di una determinata
