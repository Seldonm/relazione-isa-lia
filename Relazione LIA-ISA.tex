...
\begin{itemize}
\item {\textbf{Configurazione di Spark in Cluster Mode}}\\\\
...
Come prima cosa occorre scaricare \textbf{Apache Kafka} ( \href{http://kafka.apache.org/downloads.html}{http://kafka.apache.org/downloads.html}). La versione utilizzata è la \textbf{0.9.0.1} per \textbf{Scala 2.10} quindi \textbf{kafka\_2.10-0.9.0.1}.
\end{itemize}
